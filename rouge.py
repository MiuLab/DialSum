...
def rouge_n(evaluated_sentences, reference_sentences, n=2):
  ...
  """
  evaluated_sentences = ' '.join(str(i) for i in evaluated_sentences)
  reference_sentences = ' '.join(str(i) for i in reference_sentences)
  #remove paddings
  end = evaluated_sentences.find('0')
  if end != -1:
    evaluated_sentences = evaluated_sentences[:end]
  end = reference_sentences.find('0')
  if end != -1:
